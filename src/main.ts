...
export async function run(): Promise<void> {
  try {
    ...
    const middleware: FinalizeRequestMiddleware<ServiceInputTypes, ServiceOutputTypes> = (next) => {
      return async (args) => {
...
const uploadFile = async (
  ...
  CompleteMultipartUploadCommandOutput | AbortMultipartUploadCommandOutput | undefined
> => {
